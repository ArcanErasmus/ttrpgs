...
| Kit, Arcanist's             |   4.5  | Flint and steel, ink, inkpen, soap, waterskin
|                             |        |
|-----------------------------|        |--------------------------------
| **Tools**                   |        |
|-----------------------------|        |--------------------------------
| Compact Spellbook           |   1    | "A Scribe's Lot"
...
|-----------|-----|------------
| Light     |  38 |
| Medium    |  76 | +3 max dex to AC, -3 ACP
| Heavy     | 115 | +1 max dex to AC, -6 ACP, x3 run
