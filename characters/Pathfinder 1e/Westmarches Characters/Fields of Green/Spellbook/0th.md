...
| Components | V,S
| Range      | close (25 + 5 ft/2lvl)
| Target     | one non-magical, unattended object weighing up to 5 lb
| Duration   | C
| Save       | none
| SR         | no
...
### Oath of Anonymity - illusion (glamer)
|------------|--------------
| Casting    | 1 standard action
| Components | V
| Range      | personal
...
### Sotto Voce - necromancy [fear, mind-affecting, sonic]
|------------|--------------
| Casting    | 1 standard action
| Components | V,S
| Range      | close (25 + 5 ft/2lvl)
...
This spell originated among the followers of the an undeath cult, but necromancers and other intimidating folk outside that group are known to use it.
...
### Vacuous Vessel - illusion (glamer)
|------------|--------------
